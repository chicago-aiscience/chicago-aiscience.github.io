...
import { ResearcherAggregate, ResearcherProjection, type RawResearcher, type ResearcherState } from "./researcher.ts";
...
export interface ResearcherIngestionService {
  ...
  export class ResearcherService implements ResearcherIngestionService {
    ...
    private createCommand(researcher: RawResearcher): TheCommand<'CREATE_RESEARCHER'> {
